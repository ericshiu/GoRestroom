 ...
 * @Last modified time: 2018-03-04T16:38:52+08:00
 */
...
class SettingView extends Component{
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.container}>
          <View style={{justifyContent:'center', alignItems: 'center',marginTop:10,marginBottom:20}}>
            <Image style={styles.icon} source={require('./img/users.png')} resizeMode="contain"/>
  ...
  _showAbout(){
    AlertIOS.alert('如有问题,联系', '123@123.com', [{text: '确认'}]);
    this.props.navigator.push({
     component: About,
     title: '关于',
     barTintColor: '#fff'
